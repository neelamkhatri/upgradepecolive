  ...
  protected function valueForm(&$form, FormStateInterface $form_state) {
    ...
    if (!$exposed) {
      ...
      $form['reference_arguments'] = [
        ...
        '#description' => $this->t('Define arguments for the view that select the entities. Format is arg1/arg2/...argN. Possible arguments are: !n - argument number n of the view dynamic URL argument %, #n - argument number n of the contextual filter value, [filter_identifier] - value of the named exposed filter and other strings are passed as is.'),
